...
const GameControls = ({game, submitGuess, startNewGame, getNextQuestion}) => {
  return(
    <div id="game-controls" className="fixed bottom-0 left-0 z-10 h-16 w-screen p-3 col-span-1 grid grid-cols-3 space-x-2 pr-14 mb-8 md:w-auto md:order-2 md:static md:p-0 md:py-3 md:mx-3 md:mb-0 md:h-auto md:text-base">
      {game.currentRound > 0 ? (
